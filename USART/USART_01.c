#include "../Includes/InitializeAllModules.h"
    ...
    *El bloque del receptor esta dividido practicamente en 3 registros/fifo circular
    ...
    EL "RECEIVE SHIFT REGISTER" ACTUAR� COMO UN BUFFER DE TERCEL NIVEL, Y RETENDR� LA DATA HASTA DETECTAR UN NUEVO
    BIT DE START.
    ...
    *******************************************************************************************/
    void TxByteWaitTXC_USART0(byte DATA)
    {
        ...
        //while ( !(UCSR0A & (1<<UDRE)) ){;}	//ya estaria dem�s preguntar por UDRE solo si se espera por while ( !(UCSRA & (1<<TXC)) ){;}
        UDR0 = DATA;
