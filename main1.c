/*
 * Este proyecto ahora en Eclipse IDE:
 * 	Eclipse IDE for C/C++ Developers (includes Incubating components)
	Version: 2020-12 (4.18.0)
	Build id: 20201210-1552
	OS: Linux, v.5.12.14-arch1-1, x86_64 / gtk 3.24.29
	Java version: 15.0.1
 *
 * Arch Linux
 * linea de grabacion externa con el AVRDRAGON:
 * [jcaf@firwar Release]$ avrdude -c dragon_jtag -P usb -p m128 -U flash:w:atmega128-dimmer6zonas.hex
 * -------------------------------------------------------------------------------------------
 * -------------------------------------------------------------------------------------------
 * modificando el proyecto el 9 junio 2021.... cambiando las secciones de EEPROM a EEMEM
 * -------------------------------------------------------------------------------------------
 ...
 * 
			...
			avrdude -c dragon_jtag -P usb -p m128 -U flash:w:atmega128-dimmer6zonas.hex
			avrdude -c dragon_jtag -P usb -p m128 -U eeprom:w:atmega128-dimmer6zonas.eep
https://www.engbedded.com/fusecalc/
 Fuses
 * Ext crystal CKSEL = 1111 SUT = 11
 * [BODEN ENABLED
 * VCC=4.0
 * BOOT FLASH = 4096
 ...
 * NO HABILITADOS:
 * On-Chip debug disabled, watchdog timer always off y Atmega103 Compatibility mode OFF
  * 
 * -U lfuse:w:0x3f:m -U hfuse:w:0x81:m -U efuse:w:0xff:m 
 * 
 * Todo igual, pero activando el On-chip debug enable
 * -U lfuse:w:0x3f:m -U hfuse:w:0x01:m -U efuse:w:0xff:m 
 * 
